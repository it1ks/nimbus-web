            ...
            <div class="w-full px-5 py-16 md:py-24 text-gray-800">
                <div class="w-full max-w-6xl mx-auto">
                    <div class="text-center max-w-xl mx-auto">
                        <h1
                            class="text-6xl md:text-7xl font-bold mb-12 text-white"
                        >
                            What people <br />are saying.
                        </h1>
                    </div>
                    <div class="m-mx-3 md:flex items-start">
                            ...
                            >
                                ...
                                <div class="w-full">
                                    <p class="text-sm leading-tight">
                                        ...
                                        dolor exercitationem minima quas itaque
                                        saepe quasi architecto vel! Accusantium,
                                        vero sint recusandae cum tempora nemo
                                        commodi soluta deleniti.<span
                            ...
                            >
                                ...
                                <div class="w-full">
                                    <p class="text-sm leading-tight">
                                        ...
                                        est, dignissimos ullam error ipsam sint
                                ...
                                <div class="w-full">
                                    <p class="text-sm leading-tight">
                                        <span
                                            ...
                                            >"</span
                                        >Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Vitae, obcaecati ullam
                                        excepturi dicta error deleniti
                                        sequi.<span
                                            class="text-lg leading-none italic font-bold text-gray-400 ml-1"
                                            >"</span
                                        >
                            ...
                            >
                                ...
                                <div class="w-full">
                                    <p class="text-sm leading-tight">
                                        ...
                                        exercitationem pariatur deserunt tempora
                                        molestiae assumenda nesciunt alias eius?
                                        Illo, autem!<span
                                            class="text-lg leading-none italic font-bold text-gray-400 ml-1"
                                            >"</span
                                        >
